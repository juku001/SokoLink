...
Route::prefix('auth')->group(function () {
    ...
    Route::get('/register', [RegistrationController::class, 'index']); // this is for the customer to register and for super admin to register admin

    Route::post('/verify-email', [RegistrationController::class, 'verify']);
